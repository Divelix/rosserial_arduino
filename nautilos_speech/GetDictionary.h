#ifndef _ROS_SERVICE_GetDictionary_h
#define _ROS_SERVICE_GetDictionary_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char GETDICTIONARY[] = "nautilos_speech/GetDictionary";

  class GetDictionaryRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return GETDICTIONARY; };
    virtual const char * getMD5() override { return "d41d8cd98f00b204e9800998ecf8427e"; };

  };

  class GetDictionaryResponse : public ros::Msg
  {
    public:
  ...
  class GetDictionary {
    public:
    typedef GetDictionaryRequest Request;
    typedef GetDictionaryResponse Response;
  };
