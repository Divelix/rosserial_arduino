#ifndef _ROS_SERVICE_AddToDictionary_h
#define _ROS_SERVICE_AddToDictionary_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"

namespace nautilos_speech
{

static const char ADDTODICTIONARY[] = "nautilos_speech/AddToDictionary";

  class AddToDictionaryRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ADDTODICTIONARY; };
    virtual const char * getMD5() override { return "2bd0e7dd008cf8f52a5113ba090403b7"; };

  };

  class AddToDictionaryResponse : public ros::Msg
  {
    public:
  ...
  class AddToDictionary {
    public:
    typedef AddToDictionaryRequest Request;
    typedef AddToDictionaryResponse Response;
  };
