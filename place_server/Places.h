#ifndef _ROS_place_server_Places_h
#define _ROS_place_server_Places_h
...
namespace place_server
{
  ...
  class Places : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "place_server/Places"; };
