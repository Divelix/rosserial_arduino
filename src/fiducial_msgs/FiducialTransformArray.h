...
namespace fiducial_msgs
{
  ...
  class FiducialTransformArray : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "fiducial_msgs/FiducialTransformArray"; };
    virtual const char * getMD5() override { return "a9391b25df2859cb1ae6fa6ee45ef075"; };
