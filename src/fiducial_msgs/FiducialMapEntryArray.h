...
namespace fiducial_msgs
{
  ...
  class FiducialMapEntryArray : public ros::Msg
  {
    ...
    FiducialMapEntryArray():
      fiducials_length(0), st_fiducials(), fiducials(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "fiducial_msgs/FiducialMapEntryArray"; };
    virtual const char * getMD5() override { return "f3d7e1cb2717bda61be54acdb77f4f79"; };
